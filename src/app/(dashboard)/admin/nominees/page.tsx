  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="font-heading text-2xl font-bold text-foreground">Nominees</h1>
          ...
          <tbody className="divide-y divide-border">
            {SAMPLE_NOMINEES.map((nominee) => (
              <tr key={nominee.id} className="hover:bg-background/20 transition-colors">
                ...
                <td className="px-5 py-3.5 text-right font-medium text-foreground">{nominee.votes.toLocaleString()}</td>
                <td className="px-5 py-3.5">
