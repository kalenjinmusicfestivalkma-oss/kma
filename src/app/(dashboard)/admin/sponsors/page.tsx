  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="font-heading text-2xl font-bold text-foreground">Sponsors & Partners</h1>
              ...
              <tr key={s.id} className="hover:bg-background/20 transition-colors">
                ...
                <td className="px-5 py-4">
                  <div className="flex items-center justify-end gap-2">
                    <button className="rounded-md border border-border px-3 py-1 text-xs text-foreground/60 hover:text-foreground hover:border-border transition-all">Edit</button>
