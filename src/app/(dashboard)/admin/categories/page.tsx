          ...
          <div key={cat.id} className="rounded-xl border border-border bg-surface p-5 hover:border-primary-gold/30 transition-all group">
            <div className="flex items-start justify-between mb-4">
              ...
              <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                <button className="h-7 w-7 rounded border border-border flex items-center justify-center text-xs text-foreground/50 hover:text-foreground hover:bg-background transition-colors">✎</button>
            ...
            <div className="flex items-center justify-between border-t border-border pt-4">
              <div className="flex flex-col">
                ...
                <span className="text-foreground font-medium text-sm">{cat.nominees}</span>
              </div>
